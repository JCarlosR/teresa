            ...
            <form class="form-horizontal" method="POST">
                ...
                <fieldset>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-lg-10">
                            <input type="text" class="form-control" name="ruc" placeholder="RUC" value="{{ old('ruc', auth()->user()->ruc) }}">
                        </div>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-lg-10">
                            <input type="date" class="form-control" value="{{ auth()->user()->start_of_service }}" name="start_of_service" id="start_of_service" readonly>
